...
for word in message.split():
    ...
    emoji = emoji_map_function.get(cleaned, "")
    if emoji:
...
# Enter your message: I love to listen to music and write code while having tea , it makes me feel happy.

#  Enhanced message:

# I love ❤️  to listen to music 🎵  and write code 💻  while having tea 🍵 , it makes me feel happy. 😊
