    ...
    if(os.path.exists(TASK_FILE)):
        with open(TASK_FILE, "r", encoding="utf-8") as f:
            for line in f:
                ...
                tasks.apepend({"text": text, "done": status == "done"})
    return tasks 
...
# Enter your tasklearning python
...
# Enter task number to delete2
# task removed doing projects
...
# final tasks.txt content:
# learning python||done